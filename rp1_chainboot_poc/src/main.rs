...
#[cfg(all(
    any(feature = "rp1-spi-peer-final-record", feature = "rp1-spi-rearm-final-record", feature = "rp1-spi-fifo-final-record", feature = "rp1-spi-varied-final-record", feature = "rp1-spi-retained-final-record", feature = "rp1-spi-overflow-final-record"),
    any(
...
#[cfg(any(
    all(feature = "rp1-spi-peer-final-record", feature = "rp1-spi-rearm-final-record"),
    all(feature = "rp1-spi-fifo-final-record", any(feature = "rp1-spi-peer-final-record", feature = "rp1-spi-rearm-final-record")),
    all(feature = "rp1-spi-varied-final-record", any(feature = "rp1-spi-peer-final-record", feature = "rp1-spi-rearm-final-record", feature = "rp1-spi-fifo-final-record"))
))]
...
compile_error!("SPI retained final reader requires the isolated final record ABI");
                    ...
                    if let Some((base, size)) = rp1.shared_sram_addr {
                        match (usize::try_from(base), usize::try_from(size)) {
                            (Ok(base), Ok(size)) => {
                                ...
                                #[cfg(feature = "rp1-i2c-readonly-final-record")] { transport.log_i2c_readonly_final_result(); halt(); } #[cfg(feature = "rp1-spi-deadline-final-record")] { transport.log_spi_deadline_final_result(); halt(); } #[cfg(feature = "rp1-spi-overflow-final-record")] { transport.log_spi_overflow_final_result(); halt(); } #[cfg(feature = "rp1-spi-retained-final-record")]
                                {
...
compile_error!("SPI overflow final reader requires the isolated final record ABI");

// Append guards to preserve all prior panic-source line numbers and raw images.
#[cfg(all(
...
compile_error!("SPI deadline final reader requires the isolated final record ABI");
...
compile_error!("SPI deadline final reader requires isolated replacement-firmware reload without debugger diagnostics");
...
compile_error!("I2C read-only final reader requires the isolated final ABI and replacement-firmware reload without debugger diagnostics");
