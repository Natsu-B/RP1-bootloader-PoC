...
case "$feature" in rp1-rtos-watchdog-postack|rp1-rtos-watchdog-quiescence|rp1-rtos-watchdog-receipt|rp1-rtos-record|rp1-rtos-soak|rp1-rtos-mixed-repeat) ;; *) exit 2 ;; esac
mkdir -p "$out"
