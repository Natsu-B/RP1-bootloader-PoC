...
cargo +nightly-2026-08-27 build --offline --locked -j1 \
 ...
 --no-default-features --features log-uart,tftp-boot,require-rp1-img,rp1-rtos-record
cp target/aarch64-unknown-none-softfloat/release/rp1_chainboot_poc "$out/reader.elf"
